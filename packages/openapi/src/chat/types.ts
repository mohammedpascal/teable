...
export const PRIMARY_FIELD_TYPES = [
  FieldType.SingleLineText,
  FieldType.LongText,
  FieldType.Number,
  FieldType.SingleSelect,
      ...
      z
        .object({
          ...
          tasks: z.array(
            ...
            Create Common Fields (createCommonField):
            ...
            - First field is required, and only support these types: ${PRIMARY_FIELD_TYPES.join(', ')}

            Create AI Fields (createAiField):
            - Multiple AI field name and field type and purpose, separate by "|"
            - This is a "common" field whose data is generated by AI. Ensure its design does not overlap or conflict with other "common" fields.
            - Only allowed these types: ${AI_FIELD_TYPES.join(', ')})
            - Example: "Feedback, single select, tag emotion | Pricing, number, extract price from pdf | Cover, attachment, generate cover image by description"

            Create Link Fields (createLinkField):
            ...
            Create Lookup Fields (createLookupField):
            ...
            Create Rollup Fields (createRollupField):
            ...
            Create Formula Fields (createFormulaField):
